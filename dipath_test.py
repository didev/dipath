...
class Test_dipath(unittest.TestCase):
	...
	def test_Shot(self):
		self.assertEqual(Shot("A0000_SS_0010_comp_v01"), ("SS_0010",None))
		self.assertEqual(Shot("A0000_SS_0010_v01"), ("SS_0010",None))
		...
		self.assertEqual(Shot("/show/TEMP/seq/R1VFX/R1VFX_sh033/comp/dev/R1VFX_sh033_comp_v01"), ("R1VFX_sh033",None)) # 상위경로를 믿는다.
